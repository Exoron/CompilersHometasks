...
%code {
    ...
    #include "AbstractSyntaxTree/Statements/ScopeStatementList.h"
...
%nterm <Program*> unit
%nterm <ScopeStatementList*> scope_statements
...
scope_statements:
    "{" statements "}" { $$ = new ScopeStatementList($2); }
