...
declaration:
    "int" "identifier" ";" {
    	$$ = new DeclarationStatement(driver, $2, new NumberExpression(0));
    }
    | "int" "identifier" "=" exp ";" {
    	$$ = new DeclarationStatement(driver, $2, $4);
    };

assignment:
    "identifier" "=" exp ";" {
    	$$ = new AssignStatement(driver.variables[$1], $3);
    };
...
exp:
    ...
    | "identifier" { $$ = new VariableExpression(driver.variables[$1]); }
